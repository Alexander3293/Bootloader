...
#ifndef FLASH_STM32F4_H_
#define FLASH_STM32F4_H_
...
//void flash_stm32_write_byte_(const uint8_t *Data8, const uint32_t SizeBytes, const uint32_t AddrStart);

#endif /* FLASH_STM32F4_H_ */
